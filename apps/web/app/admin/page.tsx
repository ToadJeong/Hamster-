  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-3 md:grid-cols-2">
        ...
        <Link href="/admin/audit" className="card transition hover:-translate-y-0.5 hover:shadow-soft">
          <h3 className="font-semibold text-cocoa-500">🗂 운영 로그</h3>
          <p className="mt-1 text-sm text-cocoa-300">작성·수정·삭제·신고 전체 내역을 확인해요. (마스터 전용)</p>
        </Link>
