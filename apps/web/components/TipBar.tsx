...
/**
 * 페이지 상단의 가벼운 회전 TIP 네비게이션 바.
 * 기본 팁 목록을 일정 간격으로 바꿔가며 보여준다.
 * (관리자 편집은 추후 site_settings 연동 예정)
 */

const DEFAULT_TIPS: { text: string; href?: string }[] = [
...
export function TipBar({ tips = DEFAULT_TIPS }: { tips?: { text: string; href?: string }[] }) {
